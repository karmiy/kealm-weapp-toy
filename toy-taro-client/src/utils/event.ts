...
export class EventEmitter {
  ...
  private subscribeListener(eventName: string, listener: Listener, once = false) {
  ...
  private unsubscribeListener(eventName: string, listener?: Listener) {
    const eventListeners = this.listeners[eventName];
  ...
  public on(eventName: string, listener: Listener, options: listenerOptions = emptyObj) {
  ...
  public once(eventName: string, listener: Listener, options: listenerOptions = emptyObj) {
    const { immediatelySyncCache = true } = options;
