...
export default (app: Application) => {
  ...
  const UserCheckIn = app.model.define("user_check_in", {
    id: {
      type: INTEGER,
      primaryKey: true,
      autoIncrement: true,
  ...
  (UserCheckIn as any).associate = function () {
    (app.model.UserCheckIn as any).belongsTo(app.model.Group, {
      foreignKey: "group_id",
      targetKey: "id",
    });
    (app.model.UserCheckIn as any).belongsTo(app.model.User, {
      foreignKey: "user_id",
      targetKey: "id",
    });
  };
